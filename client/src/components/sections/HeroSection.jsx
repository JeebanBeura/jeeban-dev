      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-200px)]">
          ...
          <div className="relative flex justify-center items-center">
            ...
            {/* Main Frame Container - SQUARE 500x500 */}
            <div className="relative w-96 h-96 sm:w-[500px] sm:h-[500px]">
              ...
              <div className="absolute inset-0 rounded-3xl p-6 flex items-center justify-center">
                <div className="relative w-full h-full flex items-center justify-center">
                  ...
                  {/* Avatar Card - SQUARE 500x500 */}
                  <div className="w-96 h-96 sm:w-[484px] sm:h-[484px] rounded-2xl bg-gradient-to-br from-[#B84FD6]/40 to-[#E08AF0]/30 backdrop-blur-sm border border-[#E08AF0]/20 flex items-center justify-center relative overflow-hidden group/avatar">
