    ...
    <footer className="relative bg-gradient-to-b from-[#1A0626] via-[#2A0A3D] to-[#1A0626] border-t border-[#B84FD6]/30">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12 mb-12 text-center md:text-left">
            {/* Brand Section */}
            <div className="lg:col-span-1 sm:col-span-2">
              ...
              <div className="space-y-3">
                <a href="mailto:jb.jeebanbeura@gmail.com" className="flex items-center justify-center md:justify-start space-x-2 text-[#CFC7D8] hover:text-[#E08AF0] transition group">
                ...
                <a href="tel:+917735572179" className="flex items-center justify-center md:justify-start space-x-2 text-[#CFC7D8] hover:text-[#E08AF0] transition group">
                  <Phone size={16} className="text-[#B84FD6] group-hover:scale-110 transition-transform" />
                  <span className="text-xs">+91 7735572179</span>
                </a>
                <div className="flex items-center justify-center md:justify-start space-x-2 text-[#CFC7D8]">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={link.label}>
                    <a
                      href={link.href}
                      className="text-[#CFC7D8] hover:text-[#E08AF0] transition text-sm flex items-center justify-center md:justify-start space-x-2 group"
                    >
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <form onSubmit={handleSubscribe} className="space-y-3 max-w-sm mx-auto md:mx-0">
          ...
          <div className="border-t border-[#B84FD6]/20 pt-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6">
              <div className="text-[#9C8FB1] text-sm flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-2 text-center sm:text-left">
                <span>© 2026 Jeeban Beura. All rights reserved.</span>
                <span className="hidden sm:inline">•</span>
                <span className="flex items-center space-x-1">
                  <span>Made with</span>
                  <Heart size={14} className="text-[#E08AF0] fill-[#E08AF0]" />
                  <span>by</span>
                  <a
                    href="https://www.linkedin.com/in/jeeban-beura/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#E08AF0] hover:text-white font-medium transition-colors border-b border-transparent hover:border-[#E08AF0]"
                  >
                    Jeeban
                  </a>
                </span>
